...
from handlers import start_handler, call_bot_handler, setup_handler, error_handler
from profile_mgmt import user_info, update_user_profile, check_user_info
...
async def call_model(state: MessagesState):
    ...
    try:
        ...
        nemo_task = asyncio.create_task(get_zephyr_response())
...
async def handle_message(update: Update, context) -> None:
    missing_user_info = check_user_info()
